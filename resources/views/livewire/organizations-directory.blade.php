	...
	<aside class="md:col-span-1">
		<div class="bg-white rounded-xl border shadow-sm p-4">
			...
			<div class="grid gap-3">
				<input type="text" wire:model.live.debounce.400ms="query" placeholder="Organization name" class="w-full rounded-lg border-gray-300 focus:border-brand-600 focus:ring-brand-600" />
		...
		@else
			<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
				@foreach($organizations as $org)
					<a href="{{ route('organizations.show', $org) }}" class="block rounded-xl bg-white border p-4 shadow-sm hover:border-brand-600 hover:shadow transition">
