...
<div class="grid md:grid-cols-4 gap-6 sm:gap-8 mt-6 sm:mt-8">
	<aside class="md:col-span-1">
		<div class="relative bg-gradient-to-br from-white via-white to-brand-50 sm:from-emerald-950 sm:via-emerald-900 sm:to-emerald-800 rounded-[24px] sm:rounded-[30px] border border-gray-100 sm:border-white/15 p-0 sm:p-0 shadow-sm sm:shadow-[0_25px_60px_rgba(6,95,70,0.28)] overflow-hidden">
